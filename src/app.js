...
try {
    ...
    // 7.4) Generamos la configuración inicial para los Paquetes de Documentacion con swaggerJsdoc 
    ...
    // Activado el Modulo swaggerJsdoc y pasandole mis opciones de configuracion 
    ...
    // 20) Inyectamos Swagger como middleware para que genere y sirva la documentación en este endpoint
    ...
    // 21) Inicializando Paquetes de Rutas Dinamicas para la API 
    ...
    // 22) Paquete de RUTAS ESTATICAS para mostrar los contenidos Estaticos que estan en la carpeta PUBLIC
    app.use('/static', express.static(`${__dirname}/public`)) 


    // 23) GESTOR CENTRAL DE ERRORES - Middleware de captura general de errores
    ...
    // 24) Esta es una respuesta Generica GLOBAL en caso de que no exista NINGUNA respuesta en alguna Ruta
